...
class HomeScreen:
    def __init__(self, root):
        ...
        self._add_painel_item(painel, "img/relatorio.png", "RELATÓRIO")  # opcional, sem ação

        # Responsividade: atualizar gradiente quando redimensionar
        self.canvas_bg.bind("<Configure>", self._redesenhar_gradiente)

    # Função corrigida para carregar imagem relativa ao arquivo
    ...
    def abrir_create_box(self):
        self._abrir_tela(CreateBoxScreen)

    def abrir_update_box(self):
        self._abrir_tela(SelectAltCaixScreen)

    def abrir_select_box_create_file(self):
        self._abrir_tela(SelectCadArqScreen)

    def abrir_update_file(self):
        self._abrir_tela(SelectAltArqScreen)
